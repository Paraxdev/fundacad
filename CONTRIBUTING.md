# Contributing to FundaCAD

Thanks for your interest in FundaCAD! A few ground rules keep the project healthy
and its licensing clean.

## License of your contributions

FundaCAD is released under **AGPL-3.0-only** (see [`LICENSE`](LICENSE)). By
...
This dual-licensing grant is what lets FundaCAD stay fully open-source under the
