...
import { HOLD_MS, IDLE, holdStep } from "./holdGesture";
import type { HoldEffect, HoldEvent, HoldPhase } from "./holdGesture";
...
describe("picking a variant", () => {
  it("runs it and adopts it as the button's new default", () => {
    // The rail is supposed to learn: one `pick` both runs the tool and moves
